...
class _$GMeReq extends GMeReq {
  ...
  factory _$GMeReq([void Function(GMeReqBuilder)? updates]) =>
      (new GMeReqBuilder()..update(updates))._build();
  ...
  _$GMeReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GMeReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(operation, r'GMeReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GMeReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GMeReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GMeReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
